            ...
            <div class="column is-5-tablet is-4-desktop is-6-widescreen">
              <form class="box" @submit.prevent="saveUser">
                <div class="auth-image">
                  <img :src="auth.image" class="img-fluid" />
                </div>
                <div class="field">
...
const area = ref<string>(auth.area);
const map = ref<string>(auth.map);
const address = ref<string>(auth.address);

const imgURL = ref<string>(auth.image);
